...
const hdr = './img/spruit_sunrise_1k.hdr'
...
const gltfFather = new THREE.Mesh(geometry, material2)

scene.add(gltfFather)

new GLTFLoader().load('./models/suzanne_no_material.glb', (gltf) => {
  gltf.scene.traverse((child) => {
    ;(child as THREE.Mesh).material = material
  })
  gltfFather.add(gltf.scene)
})
